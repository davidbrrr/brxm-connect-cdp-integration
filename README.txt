- Base archetype with Relevance enabled https://xmdocumentation.bloomreach.com/trails/relevance-trail/1-include-relevance-in-a-project.html
- Engagement CDP collector and characteristics plugins added
- Engagement project ID and API credentials need to be configured on these nodes:
    - /targeting:targeting/targeting:collectors/engagement
    - /hippo:configuration/hippo:frontend/cms/hippo-targeting/collector-engagement
    - /hippo:configuration/hippo:frontend/cms/hippo-targeting/characteristic-engagement
- Add engagement tracking code to site/freemarker/connectcdpintegration/base-layout.ftl
...
After your project is set up, access the CMS at <http://localhost:8080/cms> and the site at <http://localhost:8080/connectcdpintegration>.
...
as org.example/connect-cdp-integration:0.1.0-SNAPSHOT
